...
function agregarProducto(event) {
  ...
  fetch(productosData, {
    ...
    body: JSON.stringify([...productos, nuevoProducto]) // Utilizar la variable global productos
  })
  .then(() => {
    mostrarProductos();
  })
...
function eliminarProducto(event) {
  ...
  const newData = productos.filter(producto => producto.id != id); // Utilizar la variable global productos
