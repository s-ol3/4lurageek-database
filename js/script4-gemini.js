...
<h4 class\="product\-name"\></span>{productoAgregado.name}</h4>
      ...
      `;
            ...
            // Agregar evento de eliminación al botón del producto agregado
            const botonEliminarAgregado = document.querySelector('.product-card:last-child .btn-delete');
            botonEliminarAgregado.addEventListener('click', eliminarProducto);
...
// Eventos para mostrar productos y agregar producto al cargar la página
